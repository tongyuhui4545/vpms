    ...
    <div class="content-right">
      ...
      >
        ...
        <div class="content-right-operations">
          ...
          <span class="vertical-divider-operation" />
          <el-select
          ...
          >
            ...
            <!-- <el-option label="Gantt" value="Gantt">Gantt</el-option> -->
          </el-select>
          <el-button
      ...
      <!-- ***************************bidding*********************************** -->
      <div
        v-if="tabTitle == 'Bidding' && currentTaskCategory < 3"
      ...
      <!-- ***************************formal*********************************** -->
      <div
        v-if="tabTitle == 'Formal' && currentTaskCategory < 3"
        class="content-right-table"
      >
        <el-table
          :data="tableData"
      ...
      <!-- *****************************label********************************* -->
      <LabelTaskList
        v-if="tabTitle == 'Label' && currentTaskCategory < 3"
        ref="label_task_list"
        :current-status="currentStatus"
      />
      <!-- *****************************3D bidding********************************* -->
      <ThreeDBiddingTaskList
        v-if="tabTitle == '3D bidding' && currentTaskCategory < 3"
        ref="three_d_bidding_task_list"
        :current-status="currentStatus"
      />
      <!-- *****************************3D formal********************************* -->
      <ThreeDFormalTaskList
        v-if="tabTitle == '3D formal' && currentTaskCategory < 3"
        ref="three_d_formal_task_list"
        :current-status="currentStatus"
      />
      <!-- *****************************Simulation********************************* -->
      <SimulationTaskList
        v-if="tabTitle == 'Simulation' && currentTaskCategory < 3"
...
import DueDateTag from '@/views/work-table/components/DueDateTag.vue';
...
import LabelTaskList from '@/views/work-table/LabelTaskList.vue';
import ThreeDBiddingTaskList from '@/views/work-table/ThreeDBiddingTaskList.vue';
import ThreeDFormalTaskList from '@/views/work-table/ThreeDFormalTaskList.vue';
import SimulationTaskList from '@/views//work-table/SimulationTaskList.vue';
import {
  taskList,
  getCustomTaskDetail,
  getCustomTaskList,
...
import CustomTask from '@/views/work-table/components/all-custom-task.vue';
...
export default {
  ...
  computed: {
    titleWidth() {
      if (this.currentWorkItemType === 'Pending for me') {
        return '360';
      } else {
        return '200';
      }
  ...
  methods: {
    ...
    async getTaskTotal() {
      await getTaskTotal({ project_id: this.projectId }).then((res) => {
        if (res.code === 200) {
    ...
    handleChooseTab(tab) {
      ...
      if (this.tabActive === 1) {
        // this.resetFetchTaskListParams();
        this.filterName = 'DetailQuoteTaskFilter';
        this.fetchTaskListParams.type = 1;
        this.currentType = 1;
        ...
        // this.resetFetchTaskListParams();
        this.filterName = 'DetailFormalTaskFilter';
        ...
        // this.resetFetchTaskListParams();
        this.filterName = 'DetailLabelTaskFilter';
        ...
        // this.resetFetchTaskListParams();
        this.filterName = 'DetailThreeDBiddingTaskFilter';
        ...
        // this.resetFetchTaskListParams();
        this.filterName = 'DetailThreeDFormalTaskFilter';
        ...
        // this.resetFetchTaskListParams();
        this.filterName = 'DetailSimulationTaskFilter';
        ...
        this.$refs.tableFilter.resetFilterForm();
        this.fetchTaskListParams = {};
        this.filterName = 'DetailCustomTaskFilter';
        this.currentType = 7;
    ...
    getTaskList() {
      ...
      if (this.currentTaskCategory < 3 && this.tabTitle !== 'Others') {
        taskList({...this.fetchTaskListParams, is_public:0}).then((res) => {
    ...
    handleOnFilter(formData, filterNum) {
      ...
      if (this.tabTitle !== 'Others' && this.currentTaskCategory < 3) {
        this.fetchTaskListParams.receiver = this.userInfo.id || '';
        this.fetchTaskListParams.type = this.currentType;
        this.fetchTaskListParams.status = this.currentStatus;
      }
      ...
      this.pageInfo.currentPage = 1;
      //对于通过组件引入的Lists
      if (this.tabTitle && this.currentTaskCategory < 3) {
