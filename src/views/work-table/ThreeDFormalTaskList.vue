      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_formal_task_title"
              sorter-type="d3_formal_task_title"
              sort-by="title"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_formal_title"
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_formal_assign_to"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_formal_task_project_name"
              sorter-type="d3_formal_task_project_name"
              sort-by="project_name"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_formal_project_name"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_formal_task_project_no"
              sorter-type="d3_formal_task_project_no"
              sort-by="project_no"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_formal_project_no"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_formal_task_phase_no"
              sorter-type="d3_formal_task_phase_no"
              sort-by="progress_no"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_formal_phase_no"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_formal_task_phase"
              sorter-type="d3_formal_task_phase"
              sort-by="phase"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_formal_phase"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_formal_task_solution"
              sorter-type="d3_formal_task_solution"
              sort-by="solution"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_formal_solution"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_formal_task_team"
              sorter-type="d3_formal_task_team"
              sort-by="team_id"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_formal_team"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_formal_task_calculation_status"
              sorter-type="d3_formal_task_calculation_status"
              sort-by="progress_status"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_formal_calculation_status"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_formal_task_customer_due_date"
              sorter-type="d3_formal_task_customer_due_date"
              sort-by="due_date"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_formal_customer_due_date"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_formal_task_internal_due_date"
              sorter-type="d3_formal_task_internal_due_date"
              sort-by="inner_date"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_formal_internal_due_date"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
        <template slot-scope="scope">
          <p v-if="scope.row.created_at">
            {{ formatCreationTime(scope.row['inner_date']) }}
          </p>
        </template>
      </el-table-column>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_formal_task_team_due_date"
              sorter-type="d3_formal_task_team_due_date"
              sort-by="team_due_date"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_formal_team_due_date"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_formal_task_creation_date"
              sorter-type="d3_formal_task_creation_date"
              sort-by="created_at"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_formal_creation_date"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_formal_task_creator"
              sorter-type="d3_formal_task_creator"
              sort-by="creator"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_formal_creator"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_formal_task_completed_at"
              sorter-type="d3_formal_task_completed_at"
              sort-by="completed_at"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_formal_completed_at"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        ...
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_formal_task_completor"
              sorter-type="d3_formal_task_completor"
              sort-by="completer"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_formal_completor"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
...
import { taskList, teamList, userList } from '@/api';
...
export default {
  ...
  data() {
    return {
      //3d相关
      d3FormalTaskFastFilterIcons: [
        'fast_filtered_icon_d3_formal_title',
        'fast_filtered_icon_d3_formal_project_name',
        'fast_filtered_icon_d3_formal_project_no',
        'fast_filtered_icon_d3_formal_phase_no',
        'fast_filtered_icon_d3_formal_phase',
        'fast_filtered_icon_d3_formal_solution',
        'fast_filtered_icon_d3_formal_team',
        'fast_filtered_icon_d3_formal_calculation_status',
        'fast_filtered_icon_d3_formal_customer_due_date',
        'fast_filtered_icon_d3_formal_internal_due_date',
        'fast_filtered_icon_d3_formal_team_due_date',
        'fast_filtered_icon_d3_formal_creation_date',
        'fast_filtered_icon_d3_formal_creator',
        'fast_filtered_icon_d3_formal_completed_at',
        'fast_filtered_icon_d3_formal_completor',
        'fast_filtered_icon_d3_formal_assign_to'
      ],
      ...
      d3TeamList: [],
      d3CalculationStatus: CALCULATION_STATUS_LIST,
      creatorList: [],
      //   ************************************************
   ...
   async getCreatorList() { 
    ...
    handleFastFilter(val, filterType, filterFor) {
      ...
      switch (filterFor) {
        case 'title':
          formData.title = val;
          this.fastFilteredIconName = 'fast_filtered_icon_d3_formal_title';
          break;
        case 'project_name':
        ...
        case 'phase_no':
          ...
          this.fastFilteredIconName = 'fast_filtered_icon_d3_formal_phase_no';
          break;
        case 'team_id':
          formData.team_id = val.value;
          this.fastFilteredIconName = 'fast_filtered_icon_d3_formal_team';
          val = val.label;
          break;
        case 'due_date':
      ...
      switch (filterType) {
        case 'AssignTo':
          ...
          val = val.name;
          this.fastFilteredIconName = 'fast_filtered_icon_d3_formal_assign_to';
          break;
        case 'ProjectNo':
          formData.project_no = val;
          this.fastFilteredIconName = 'fast_filtered_icon_d3_formal_project_no';
          break;
        case 'Creator':
          formData.creator = val.id;
          val = val.name;
          this.fastFilteredIconName = 'fast_filtered_icon_d3_formal_creator';
          break;
        case 'Solution':
          formData.solution = val.value;
          this.fastFilteredIconName = 'fast_filtered_icon_d3_formal_solution';
          val = val.label;
          break;
        ...
        case 'Phase':
          ...
          this.fastFilteredIconName = 'fast_filtered_icon_d3_formal_phase';
          val = val.label;
          break;
        ...
        case 'Completer':
          ...
          val = val.name;
          this.fastFilteredIconName = 'fast_filtered_icon_d3_formal_completor';
          break;
        default:
          break;
      }
    ...
    showFastFilterIcon() {
      this.d3FormalTaskFastFilterIcons.forEach((item) => {
