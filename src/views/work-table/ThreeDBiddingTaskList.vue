      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_bidding_task_title"
              sorter-type="d3_bidding_task_title"
              sort-by="title"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_bidding_title"
            ...
            <div style="flex: 1">
              ...
              >
                <p
                  ...
                  @click="goToPhase('bidding', scope.row)"
                >
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_bidding_assign_to"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_bidding_task_project_name"
              sorter-type="d3_bidding_task_project_name"
              sort-by="project_name"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_bidding_project_name"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
        <template slot-scope="scope">
          <p
            ...
            class="table-project-clickable-text"
            @click="goToProject('bidding', scope.row)"
          >
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_bidding_task_project_no"
              sorter-type="d3_bidding_task_project_no"
              sort-by="project_no"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_bidding_project_no"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_bidding_task_progress_no"
              sorter-type="d3_bidding_task_progress_no"
              sort-by="progress_no"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_bidding_progress_no"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_bidding_task_phase"
              sorter-type="d3_bidding_task_phase"
              sort-by="phase"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_bidding_phase"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_bidding_task_solution"
              sorter-type="d3_bidding_task_solution"
              sort-by="solution"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_bidding_solution"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_bidding_task_team"
              sorter-type="d3_bidding_task_team"
              sort-by="team_id"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_bidding_team"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_bidding_task_calculation_status"
              sorter-type="d3_bidding_task_calculation_status"
              sort-by="progress_status"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_bidding_calculation_status"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_bidding_task_customer_due_date"
              sorter-type="d3_bidding_task_customer_due_date"
              sort-by="due_date"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_bidding_customer_due_date"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
        ...
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            >
              ...
              <FastFilter
                fast-filter-type="DateRangeFastFilter"
                filter-for="inner_date"
                @fast-filter="handleFastFilter"
              />
            </el-popover>
            <Sorter
              ref="d3_bidding_task_internal_due_date"
              sorter-type="d3_bidding_task_internal_due_date"
              sort-by="inner_date"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_bidding_internal_due_date"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_bidding_task_team_due_date"
              sorter-type="d3_bidding_task_team_due_date"
              sort-by="team_due_date"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_bidding_team_due_date"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_bidding_task_creation_date"
              sorter-type="d3_bidding_task_creation_date"
              sort-by="created_at"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_bidding_creation_date"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_bidding_task_creator"
              sorter-type="d3_bidding_task_creator"
              sort-by="creation_name"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
              ref="fast_filtered_icon_d3_bidding_creator"
              @cancel="handleCancelFastFilter"
            />
          </div>
        </template>
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_bidding_completion_time_sorter"
              sorter-type="d3_bidding_completion_time_sorter"
      ...
      >
        <template slot="header">
          <div style="display: flex; align-items: center">
            ...
            <Sorter
              ref="d3_bidding_completer_sorter"
              sorter-type="d3_bidding_completer_sorter"
              sort-by="completer"
              @on-sort="handleSort"
            />
            <FastFilteredIcon
...
export default {
  ...
  data() {
    return {
      fastFilterIcons: [
        'fast_filtered_icon_d3_bidding_title',
        'fast_filtered_icon_d3_bidding_project_name',
        'fast_filtered_icon_d3_bidding_project_no',
        'fast_filtered_icon_d3_bidding_progress_no',
        'fast_filtered_icon_d3_bidding_phase',
        'fast_filtered_icon_d3_bidding_solution',
        'fast_filtered_icon_d3_bidding_team',
        'fast_filtered_icon_d3_bidding_calculation_status',
        'fast_filtered_icon_d3_bidding_customer_due_date',
        'fast_filtered_icon_d3_bidding_internal_due_date',
        'fast_filtered_icon_d3_bidding_team_due_date',
        'fast_filtered_icon_d3_bidding_creation_date',
        'fast_filtered_icon_d3_bidding_creator',
        'fast_filtered_icon_completion_time',
        'fast_filtered_icon_completer',
        'fast_filtered_icon_d3_bidding_assign_to'
      ],
      sorterList: [
        'd3_bidding_task_title',
        'd3_bidding_task_project_name',
        'd3_bidding_task_project_no',
        'd3_bidding_task_progress_no',
        'd3_bidding_task_phase',
        'd3_bidding_task_solution',
        'd3_bidding_task_team',
        'd3_bidding_task_calculation_status',
        'd3_bidding_task_customer_due_date',
        'd3_bidding_task_internal_due_date',
        'd3_bidding_task_team_due_date',
        'd3_bidding_task_creation_date',
        'd3_bidding_task_creator',
        'd3_bidding_completion_time_sorter',
        'd3_bidding_completer_sorter'
      ],
      d3TeamList: [],
    ...
    handleFastFilter(val, filterType, filterFor) {
      ...
      switch (filterType) {
        case 'Phase':
          ...
          val = val.label;
          this.fastFilteredIconName = 'fast_filtered_icon_d3_bidding_phase';
          break;
        case 'Solution':
          formData['solution'] = val.value;
          val = val.label;
          this.fastFilteredIconName = 'fast_filtered_icon_d3_bidding_solution';
          break;
        ...
        case 'Creator':
          ...
          val = val.name;
          this.fastFilteredIconName = 'fast_filtered_icon_d3_bidding_creator';
          break;
        case 'CompletionTime':
        ...
        case 'Completer':
          ...
          val = val.name;
          this.fastFilteredIconName = 'fast_filtered_icon_d3_bidding_assign_to';
          break;
        default:
          break;
      }
      switch (filterFor) {
        ...
        case 'title':
          formData['title'] = val;
          this.fastFilteredIconName = 'fast_filtered_icon_d3_bidding_title';
          break;
        case 'project_name':
        ...
        case 'team_id':
          ...
          val = val.label;
          this.fastFilteredIconName = 'fast_filtered_icon_d3_bidding_team';
          break;
        default:
          break;
      }
