...
export default {
  ...
  data() {
    return {
      ...
      // barColors: ['#76ED90', '#5EC6FF', '#9E87E9', '#22D9AE', '#5B8FF9'],
      // 横坐标轴线颜色
    ...
    drawChart() {
      ...
      const option = {
        tooltip: {
          ...
          extraCssText:
            'border-radius: 4px;  overflow-x: hidden; width: 264px; box-shadow: 0px 2px 4px 1px rgba(0,0,0,0.1)'
        },
        xAxis: {
          name: 'Month',
          nameTextStyle: {
